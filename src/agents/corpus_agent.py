...
def prepare_corpus_context(
    ...
    report_path = export_context_report(contract_path, context_pack, None, workspace, output_root)
...
def analyze_corpus_context(
    ...
    report_path = export_context_report(contract_path, context_pack, evidence_pack, workspace, output_root)
    return {
